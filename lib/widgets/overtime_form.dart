...
class OverTimeFormView extends StatefulWidget {
  Function(FormModel model) onSubmit;
  OverTimeFormView({super.key, required this.onSubmit});

  @override
  State<StatefulWidget> createState() => OverTimeFormState();
}

class OverTimeFormState extends State<OverTimeFormView> {
              ...
              onPressed: () {
                widget.onSubmit(
                  FormModel(
                      ...
                      overtimeResults: resultController.text),
                );
              }),
        ),
      ],
